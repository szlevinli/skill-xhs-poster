...
from .products.fetch import build_fetch_products_payload
from .content.generate import build_generate_content_payload
from .phase3 import (
...
def generate_content_command(
    ...
    payload, exit_code = build_generate_content_payload(contents_per_product=contents_per_product)
    emit_json(payload)
    raise typer.Exit(code=exit_code)
